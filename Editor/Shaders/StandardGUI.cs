...
{
    public static class StandardGUI
    {
        ...
        public static class Styles
        {
            ...
            public static GUIContent thresholdText = new GUIContent("Threshold",
                "Determines value that is used to clamp lighting.");
        }
        ...
        public struct SimpleLitProperties
        {
            ...
            public MaterialProperty threshold;
            ...
            public SimpleLitProperties(MaterialProperty[] properties)
            {
                ...
                threshold = BaseShaderGUI.FindProperty("_Threshold", properties, false);
        ...
        public static void Inputs(SimpleLitProperties properties, MaterialEditor materialEditor, Material material)
        {
            ...
            var threshold = properties.threshold.floatValue;
            threshold = EditorGUILayout.Slider(Styles.thresholdText, threshold, 0f, 1f);
            if (EditorGUI.EndChangeCheck())
            {
                properties.threshold.floatValue = threshold;
            }
